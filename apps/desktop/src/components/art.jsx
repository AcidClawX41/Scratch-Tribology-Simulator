...
import { Art, memoArt } from "./Scene.jsx";

/* Ilustraciones realistas (geometría en @sts/core/art.js). uid evita ids de SVG repetidos en el DOM. */
...
export function MaterialSwatch({ target, w = 120, h = 34, uid = "sw", detail = 0.7, rx = 7 }) {
  ...
  return <Art art={art} viewBox={`0 0 ${w} ${h}`} height="100%" />;
}

export function GemIcon({ inlay, size = 18 }) {
